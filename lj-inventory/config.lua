...
Config.MaxOtherInventoryWeight = 120000 -- Max weight a player can carry (default 120kg, written in grams)
Config.MaxOtherInventorySlots = 28 -- Max inventory slots for a player
